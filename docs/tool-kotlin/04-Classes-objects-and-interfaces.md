# 4 <u>类、对象和接口</u><ShowS>`Classes, objects, and interfaces`</ShowS>
...
::: info Listing 4.17. Expressions as sealed classes
...
::: info Listing 4.38. Accessing local variables from an anonymous object
