4Classes, objects, and interfaces
This chapter covers
...
override fun showOff() { #1 super<Clickable>.showOff() #2
...
4.1.3Visibility modifiers: public by default
...
val listener = object : MouseListener { override fun onEnter() { /* ... */ } override fun onClick() { /* ... */ }
}
